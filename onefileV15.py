...
class DetectionWorker(QObject):
    ...
    def send_arduino_fan_on(self):
        self._send_arduino_command("FANON", require_enabled=False)

    @pyqtSlot()
    def send_arduino_fan_off(self):
        self._send_arduino_command("FANOFF", require_enabled=False)
...
class MainWindow(QMainWindow):
    ...
    def _create_arduino_group(self):
        ...
        self.arduino_fan_off_btn = QPushButton('Fan OFF')
