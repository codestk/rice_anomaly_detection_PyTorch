...
class MainWindow(QMainWindow):
    ...
    def _create_arduino_group(self):
        ...
        self.arduino_trigger_delay_spin = QDoubleSpinBox()
        self.arduino_trigger_delay_spin.setRange(0.0, 30.0)
        self.arduino_trigger_delay_spin.setDecimals(1)
        self.arduino_trigger_delay_spin.setSingleStep(0.1)
        self.arduino_trigger_delay_spin.setValue(0.0)
        self.arduino_trigger_delay_spin.valueChanged.connect(self._arduino_config_changed)
        self.arduino_trigger_delay_spin.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self.arduino_clear_delay_spin.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
