...
class AnomalyDetector:
    ...
    def process_frame(self, frame):
        ...
        # --- MORPHOLOGICAL CLOSING ADDED HERE ---
        # This new block fills the gaps inside the detected edges.
        # You can adjust kernel_size and iterations to get the best result.
        kernel_size = 15  # The size of the "brush" to close gaps.
        ...
        # Find contours on the NEW processed image (processed_thresh)
...
class MainWindow(QMainWindow):
    ...
    def _toggle_controls(self, enable):
        ...
        # FIX: The capture button should be enabled when detection is running (enable=False)
        # and disabled when it's stopped (enable=True). This logic matches the stop_btn.
