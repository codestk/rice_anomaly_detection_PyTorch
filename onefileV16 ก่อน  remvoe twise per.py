    ...
    def process_frame(self, frame, is_first_frame=False):
        ...
        if self.mode == 'color':
            ...
            if hsv_gpu is not None:
                ...
                mask_secondary = self._mask_from_hsv_torch(
        ...
        if hsv_gpu is not None:
            ...
            mask_color_secondary = self._mask_from_hsv_torch(
                hsv_gpu, self.h2_low, self.h2_high, self.s2_min, self.v2_min, self.secondary_hue_enabled
            )
...
class DetectionWorker(QObject):
    ...
    def _process_frame_impl(self, cv_img):
        ...
        if self.tripwire_enabled and is_anomaly_present:
            ...
            if is_anomaly:
                is_new_anomaly_found = True
        tripwire_ms = (time.perf_counter() - tripwire_start) * 1000.0
