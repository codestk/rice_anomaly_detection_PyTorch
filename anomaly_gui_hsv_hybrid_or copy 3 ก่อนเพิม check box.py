...
from PyQt6.QtWidgets import (
    ...
    QStatusBar, QComboBox, QSizePolicy, QMessageBox # <--- 1. IMPORTED QMESSAGEBOX
)
...
class MainWindow(QMainWindow):
    ...
    def _create_controls(self):
        ...
        self.res_combo = QComboBox(); self.resolution_options = ['Source/Native','2592x1944','2304x1296','1920x1080','1600x900','1280x720','1024x576','960x540','800x450','640x480']; self.res_combo.addItems(self.resolution_options); cr.addWidget(self.res_combo)
        ...
        left.addLayout(cr)
        # right panel
        self.auto_save_check = QCheckBox('Auto-save Detections'); self.auto_save_check.toggled.connect(self._update_auto_save_status); right.addWidget(self.auto_save_check)
        # Mode selector
        ...
        self.clear_btn = QPushButton('Clear Output'); self.clear_btn.clicked.connect(self._clear_output_folders) # <--- 2. ADDED BUTTON AND CONNECTION
        buttons.addWidget(self.start_btn); buttons.addWidget(self.stop_btn); buttons.addWidget(self.test_image_btn); buttons.addWidget(self.capture_btn); buttons.addWidget(self.clear_btn) # <--- 2. ADDED BUTTON WIDGET
        buttons.addStretch()
    ...
    # <--- 3. ADDED THE ENTIRE FUNCTION FOR DELETING FILES --->
